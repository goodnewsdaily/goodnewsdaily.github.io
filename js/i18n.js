/**
 * i18n.js - Translation engine for GoodNewsDaily
 */
const I18n = (() => {
  let _strings = {};
  let _lang = 'en';
  ...
  async function init() {
    _lang = localStorage.getItem('gnd-lang') || 'en';
  ...
  async function setLang(lang) {
    _lang = lang;
    localStorage.setItem('gnd-lang', lang);
    ...
    _applyTranslations();
    _updateSwitcher();
    document.dispatchEvent(new CustomEvent('gnd-lang-change', { detail: { lang: _lang } }));
  }
  ...
  return { init, t, getLang, getManifest, getLocalizedText, setLang };
})();
