...
function _comedianCardHtml(c) {
  ...
  return `<div class="comedian-card">
    ...
    ${c.youtube_id ? `<div style="text-align:right;margin-top:0.75rem"><a href="https://www.youtube.com/watch?v=${c.youtube_id}" target="_blank" rel="noopener" class="btn btn-secondary">\u25b6 Watch</a></div>` : ''}
  </div>`;
}
